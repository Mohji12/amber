...
import { ArrowRight, Users, MessageCircle, Sparkles, Globe, Award, Truck, Shield } from 'lucide-react';
...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="pt-24 pb-16 min-h-screen flex items-center relative overflow-hidden hero-no-shadow">
      ...
      {/* Enhanced Floating WhatsApp Button with pulse effect */}
      <a
        href="https://wa.me/917978801622"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 z-50 animate-pulse hover:animate-none"
      >
