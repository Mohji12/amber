        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="hidden sm:flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-all hover:scale-105 font-medium shadow-lg"
            >
          ...
          <div className="md:hidden py-4 border-t border-green-100 bg-white/95 backdrop-blur-md">
            <nav className="space-y-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-colors font-medium mx-4 justify-center"
              >
                <MessageCircle size={18} />
                <span>WhatsApp</span>
              </a>
